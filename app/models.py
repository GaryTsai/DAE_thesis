...
class Project(db.Model):
    ...
    def __init__(self, id, project_name, account):
        self.id = id
...
class Gateway(db.Model):
    ...
    lat = db.Column(db.VARCHAR(255))
    lng = db.Column(db.VARCHAR(255))

    def __init__(self, id, uid,country, city, physical_address, gateway_name, project_id):
        self.id = id
        self.uid = uid
...
class Node(db.Model):
    ...
    gateway_address = db.Column(db.VARCHAR(20))
    model = db.Column(db.VARCHAR(20))
    ...
    def __init__(self, id, gateway, model, node_name, node, gateway_address,  created_at, updated_at, model_type, node_state, group_id):
        self.id = id
